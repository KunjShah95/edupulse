...
async function main() {
                            ...
                            create: [
                                {
                                    ...
                                    icon: '🎉',
                                    rarity: client_1.BadgeRarity.COMMON,
                                },
                                {
                                    name: 'Quiz Master',
                                    description: 'Completed 10 quizzes',
                                    icon: '🏆',
                                    rarity: client_1.BadgeRarity.RARE,
                                },
                            ],
                        },
                    },
                        ...
                        badges: {
                            create: [
                                ...
                                },
                                {
                                    ...
                                    icon: '🔥',
                                    rarity: client_1.BadgeRarity.EPIC,
                                },
                            ],
                        },
                    },
    ...
    await prisma.grade.createMany({
        data: [
            // Alice's grades
            { studentId: students[0].student.id, courseId: courses[0].id, type: client_1.GradeType.ASSIGNMENT, title: 'Assignment 1', score: 45, maxScore: 50, percentage: 90, weight: 1 },
            { studentId: students[0].student.id, courseId: courses[0].id, type: client_1.GradeType.QUIZ, title: 'Chapter 1 Quiz', score: 18, maxScore: 20, percentage: 90, weight: 0.5 },
            { studentId: students[0].student.id, courseId: courses[1].id, type: client_1.GradeType.MIDTERM, title: 'Midterm Exam', score: 78, maxScore: 100, percentage: 78, weight: 2 },
            // Bob's grades
            { studentId: students[1].student.id, courseId: courses[0].id, type: client_1.GradeType.ASSIGNMENT, title: 'Assignment 1', score: 38, maxScore: 50, percentage: 76, weight: 1 },
            { studentId: students[1].student.id, courseId: courses[0].id, type: client_1.GradeType.QUIZ, title: 'Chapter 1 Quiz', score: 15, maxScore: 20, percentage: 75, weight: 0.5 },
        ],
    });
    ...
    await prisma.attendance.createMany({
        data: attendanceDates.flatMap(date => [
            { studentId: students[0].student.id, courseId: courses[0].id, date, status: client_1.AttendanceStatus.PRESENT },
            { studentId: students[1].student.id, courseId: courses[0].id, date, status: Math.random() > 0.2 ? client_1.AttendanceStatus.PRESENT : client_1.AttendanceStatus.ABSENT },
        ]),
    });
